...
public class TestLinkExcelToXml {
	...
	public void run() throws Exception {
		...
		String filePath = "/Users/yzhang/git/YuanTest/TestLinkExcelToXml/workbook/";
		String xlsFile = "/Users/yzhang/git/YuanTest/TestLinkExcelToXml/workbook/TestCaseSample.xls";

		excelToXML(filePath, xlsFile);

	}

	public static void excelToXML(String filePath, String xlsFile) throws Exception {
		...
		XMLWriter xmlWriter = new XMLWriter(new FileOutputStream(filePath + testSuite + ".xml"), format);
